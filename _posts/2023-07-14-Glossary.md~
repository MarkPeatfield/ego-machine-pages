...
- __Printers:__ are mechanisms sent to other worlds to gather materials and await printing instructions from the Empire. Usually, they construct mapping mechanisms from locally gathered metals, or more recently, biological materials. Recent advances in germplasm manipulation have allowed Printers to manipulate the local wildlife to map, gather resources and even build civilisations. They are not sentient but are completely autonomous. 
